...
import {PivotData, sortAs, getSort, locales_mod} from './Utilities';
    ...
    return (
      <div className="pvtDropdown" style={{zIndex: this.props.zIndex}}>
        ...
        >
          ...
          {(
            locales_mod["renderers"][this.props.current]
              ? locales_mod["renderers"][this.props.current]
              : locales_mod["aggregators"][this.props.current]
                ? locales_mod["aggregators"][this.props.current]
                : this.props.current
          ) || <span>&nbsp;</span>}
        </div>
        ...
        {this.props.open && (
          <div className="pvtDropdownMenu">
            {this.props.values.map(r => (
              ...
              >
                {
                  locales_mod["renderers"][r]
                    ? locales_mod["renderers"][r]
                    : locales_mod["aggregators"][r]
                      ? locales_mod["aggregators"][r]
                      : r
                }
              </div>
